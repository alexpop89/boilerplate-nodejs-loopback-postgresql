import {ClassDecoratorFactory, Constructor, MetadataAccessor, MetadataInspector, MethodDecoratorFactory, inject} from '@loopback/context';
...
export namespace ws {
  ...
  export function subscribe(...messageTypes: (string | RegExp)[]) {
    return MethodDecoratorFactory.createDecorator('websocket:subscribe', messageTypes);
  }
