...
export class RoleController {
  ...
  async findById(@param.path.string('id') id: number, @param.filter(Role, {exclude: 'where'}) filter?: FilterExcludingWhere<Role>): Promise<Role> {
  ...
  async replaceById(@param.path.string('id') id: number, @requestBody() role: Role): Promise<void> {
