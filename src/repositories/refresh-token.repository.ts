...
export class RefreshTokenRepository extends CustomCrudRepository<RefreshToken, typeof RefreshToken.prototype.id, RefreshTokenRelations> {
  ...
  async create(entity: DataObject<RefreshToken>, options?: Options): Promise<RefreshToken> {
    entity.expires = entity.expires ?? addDays(new Date(), this.refreshTokenExpirationDays);
